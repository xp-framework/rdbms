 ...
 *
 */
class SqlSrvDialect extends SQLDialect {
  private static
    $dateparts= [
      'microsecond' => false,
    ],
  ...
  public function datepart($datepart) {
    ...
    if (false === self::$dateparts[$datepart]) throw new \lang\IllegalArgumentException('SqlSrv does not support datepart '.$datepart);
