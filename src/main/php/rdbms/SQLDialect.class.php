...
abstract class SQLDialect {
  ...
  public function formatFunction(SQLFunction $func) {
    ...
    throw new \lang\IllegalArgumentException('SQL function "'.$func->func.'()" not known');
  }
  ...
  public function datepart($datepart) {
    ...
    if (!array_key_exists($datepart, self::$dateparts)) throw new \lang\IllegalArgumentException('datepart '.$datepart.' does not exist');
  ...
  public function datatype($datatype) {
    ...
    if (!array_key_exists($datatype, self::$datatypes)) throw new \lang\IllegalArgumentException('datatype '.$datatype.' does not exist');
